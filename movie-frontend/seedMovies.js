...
const movies = [
  ...
  },
  {
    ...
    rating: 4.3,
    isPremium: false,
    image: "https://m.media-amazon.com/images/M/MV5BNDk4NDkzNzU3Nl5BMl5BanBnXkFtZTgwMDk4NDkzNzU3NjE@._V1_.jpg",
    banner: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=1920",
    trailer: "https://www.youtube.com/embed/bTYSgExOAwA",
    videoUrl: "https://www.youtube.com/embed/bTYSgExOAwA",
    mood: ["excited", "thoughtful"],
    trailerPreview: "",
  },
  ...
  // ── DRAMA ──
  {
    ...
    rating: 5.0,
    isPremium: true,
    image: "https://m.media-amazon.com/images/M/MV5BNDE3ODcxYzMtY2YzZC00NiYyLTg3YzItOTk2OWZlZTljNzIxXkEyXkFqcGdeQXVyNjAwNDUxODI@._V1_.jpg",
  ...
  {
    title: "Home Alone",
    description: "An eight-year-old troublemaker must protect his house from a pair of burglars when he is accidentally left home alone by his family.",
    genre: "Comedy",
    year: 1990,
    duration: "1h 43m",
    rating: 4.5,
    ...
    banner: "https://images.unsplash.com/photo-1574267432553-4b4628081c31?w=1920",
    trailer: "https://www.youtube.com/embed/1TPn4G-Xtm8",
    videoUrl: "https://www.youtube.com/embed/1TPn4G-Xtm8",
    mood: ["happy", "excited"],
    trailerPreview: "",
  },
  {
  ...
  },
  {
    ...
    rating: 4.2,
    isPremium: false,
    image: "https://m.media-amazon.com/images/M/MV5BMTc0NjIyMjA2OF5BMl5BanBnXkFtZTcwMDA1NjgyMQ@@._V1_.jpg",
    banner: "https://images.unsplash.com/photo-1574267432553-4b4628081c31?w=1920",
  ...
  {
    title: "Get Out",
    description: "A young African-American visits his white girlfriend's parents for the weekend, where his uneasiness grows as a series of disturbing events unfold.",
    genre: "Horror",
    year: 2017,
    duration: "1h 44m",
    rating: 4.5,
    isPremium: true,
    image: "https://m.media-amazon.com/images/M/MV5BMjUxMDQwNjcyMl5BMl5BanBnXkFtZTgwNzcwMzc1MTI@._V1_.jpg",
    banner: "https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=1920",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/WR7cc5t7tv8",
    mood: ["scared", "excited"],
    trailerPreview: "",
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/FnCdOQsX5kc",
    mood: ["scared"],
    trailerPreview: "",
  },
  ...
  // ── SCI-FI ──
  {
    ...
    rating: 4.9,
    isPremium: true,
    image: "https://m.media-amazon.com/images/M/MV5BNzQzOTk3OTAtNDQ0Zi00ZTVlLTM5YTctZjEwM2ZlZjk5OTgxXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_.jpg",
    banner: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=1920",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/OiTiKOy59o4",
    mood: ["excited", "thoughtful"],
    trailerPreview: "",
  },
  {
  ...
  },
  {
    ...
    description: "Sparks fly when spirited Elizabeth Bennet meets single, rich, and proud Mr. Darcy. But Mr. Darcy reluctantly finds himself falling in love with her.",
    genre: "Romance",
    year: 2005,
    duration: "2h 9m",
    rating: 4.6,
    isPremium: false,
    image: "https://m.media-amazon.com/images/M/MV5BMTA1NDQ3NTcyOTNeQTJeQWpwZ15BbWU3MDQ5MDE2MzQ@._V1_.jpg",
    banner: "https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=1920",
    trailer: "https://www.youtube.com/embed/1dqte7CeRkI",
    videoUrl: "https://www.youtube.com/embed/1dqte7CeRkI",
  ...
  // ── THRILLER ──
  {
    ...
    banner: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=1920",
    trailer: "https://www.youtube.com/embed/4Cs5oNhKOsQ",
    videoUrl: "https://www.youtube.com/embed/4Cs5oNhKOsQ",
    mood: ["thoughtful", "scared"],
    trailerPreview: "",
  },
  {
    title: "Parasite",
...
async function seedMovies() {
  try {
    ...
    console.log(`\n🎬 Done! ${success} movies added, ${failed} failed.`);
  } catch (err) {
