...
import {
  FaFilm, FaUsers, FaChartBar, FaPlus, FaEdit,
  FaTrash, FaStar, FaCrown, FaEye, FaSearch,
...
function Admin() {
  ...
  const handleSaveMovie = async () => {
    if (!movieForm.title || !movieForm.genre) {
      showError("Title and Genre are required!");
      return;
    }
    const moodArray = movieForm.mood
      ? movieForm.mood.split(",").map(m => m.trim()).filter(Boolean)
      : [];
  ...
  const handleEditMovie = (movie) => {
    ...
    setMovieForm({
      ...
      mood: Array.isArray(movie.mood) ? movie.mood.join(", ") : "",
    });
    setShowForm(true);
    setActiveTab("movies");
    window.scrollTo(0, 0);
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "16px", background: "linear-gradient(135deg, #dc2626, #991b1b)", borderRadius: "12px", marginBottom: "20px", textAlign: "center" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "50%", background: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", fontWeight: 900, color: "white", margin: "0 auto 8px" }}>
              {user.name.charAt(0).toUpperCase()}
            </div>
            <p style={{ color: "white", fontWeight: 800, fontSize: "14px", margin: "0 0 2px" }}>{user.name}</p>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "11px", margin: 0 }}>👑 Administrator</p>
          </div>

          <p style={{ color: theme.textSub, fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 8px 8px" }}>
            Navigation
          </p>
          ...
          {stats && (
            <div style={{ marginTop: "24px", padding: "16px", background: theme.bgInput, borderRadius: "12px" }}>
              <p style={{ color: theme.textSub, fontSize: "11px", fontWeight: 700, textTransform: "uppercase", margin: "0 0 12px" }}>Quick Stats</p>
              {[
          ...
          {loading ? (
            ...
            <>
                ...
                <div>
                  <div style={{ marginBottom: "32px" }}>
                    ...
                    <p style={{ color: theme.textSub, margin: 0 }}>
                      Here's your CineStream overview for today.
                    </p>
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px", marginBottom: "32px" }}>
                    {[
                      ...
                      <div key={stat.label} style={{ background: theme.bgCard, border: "1px solid " + theme.border, borderRadius: "16px", padding: "20px", display: "flex", alignItems: "center", gap: "14px", transition: "box-shadow 0.2s" }}
                        onMouseEnter={e => e.currentTarget.style.boxShadow = "0 8px 24px rgba(0,0,0,0.15)"}
                        onMouseLeave={e => e.currentTarget.style.boxShadow = "none"}
                      >
                        <div style={{ width: "52px", height: "52px", borderRadius: "14px", background: stat.bg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", flexShrink: 0 }}>
                          {stat.emoji}
                        </div>
                        <div>
                          <p style={{ color: theme.textSub, fontSize: "12px", margin: "0 0 4px", fontWeight: 600 }}>{stat.label}</p>
                      ...
                      {mostWatched.length === 0 ? (
                        ...
                        mostWatched.slice(0, 3).map((movie, index) => (
                          <div key={movie._id} style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                            <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: index === 0 ? "#eab308" : index === 1 ? "#9ca3af" : "#b45309", color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: 900, flexShrink: 0 }}>
                              {index + 1}
                            </div>
                            <img src={movie.image} alt={movie.title} onError={e => { e.target.src = "https://placehold.co/32x44/1a1a2e/ffffff?text=M"; }} style={{ width: "32px", height: "44px", objectFit: "cover", borderRadius: "6px" }} />
                            <div style={{ flex: 1 }}>
                      ...
                      {recentMovies.slice(0, 5).map((movie, index) => (
                        <div key={movie._id} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px 0", borderBottom: index < recentMovies.length - 1 ? "1px solid " + theme.border : "none" }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "6px", flexShrink: 0 }}>
                            ...
                            {movie.isPremium && <span style={{ background: "#eab30822", color: "#eab308", fontSize: "9px", padding: "2px 6px", borderRadius: "999px", fontWeight: 700 }}>💎</span>}
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  {showForm && (
                    <div style={{ background: theme.bgCard, border: "1px solid " + theme.border, borderRadius: "16px", padding: "24px", marginBottom: "24px" }}>
                      <h3 style={{ color: theme.textMain, fontWeight: 800, fontSize: "16px", margin: "0 0 20px", display: "flex", alignItems: "center", gap: "8px" }}>
                        {editingMovie ? <><FaEdit /> Edit Movie</> : <><FaPlus /> Add New Movie</>}
                      </h3>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "14px", marginBottom: "14px" }}>
                        {[
                          ...
                          { label: "Mood (comma separated)", key: "mood", placeholder: "happy, excited, romantic" },
                        ].map((field) => (
                          <div key={field.key}>
                      ...
                      <tbody>
                        {filteredMovies.map((movie, index) => (
                          ...
                          >
                            ...
                            <td style={{ padding: "10px 16px", color: theme.textMain, fontWeight: 700, fontSize: "14px", maxWidth: "180px" }}>
              ...
              {activeTab === "users" && (
                <div>
                  <div style={{ marginBottom: "24px" }}>
                    ...
                    <p style={{ color: theme.textSub, margin: 0, fontSize: "14px" }}>{users.length} total users • {users.filter(u => u.isPremium).length} premium</p>
                  </div>
                          ...
                          >
                            ...
                            <td style={{ padding: "14px 16px" }}>
                              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: u.isAdmin ? "#dc2626" : "#3b82f6", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 800, fontSize: "14px", flexShrink: 0 }}>
                                  {u.name.charAt(0)}
                                </div>
              ...
              {activeTab === "analytics" && (
                <div>
                  <div style={{ marginBottom: "32px" }}>
                    <h1 style={{ fontSize: "24px", fontWeight: 900, margin: "0 0 4px" }}>🔥 Analytics</h1>
                    <p style={{ color: theme.textSub, margin: 0, fontSize: "14px" }}>Most watched movies and platform stats</p>
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "16px", marginBottom: "32px" }}>
                    {[
                      ...
                      <div key={stat.label} style={{ background: theme.bgCard, border: "1px solid " + theme.border, borderRadius: "16px", padding: "20px", textAlign: "center" }}>
                  ...
                  <div style={{ background: theme.bgCard, border: "1px solid " + theme.border, borderRadius: "16px", padding: "24px", marginBottom: "24px" }}>
                    <h3 style={{ color: theme.textMain, fontWeight: 800, fontSize: "16px", margin: "0 0 20px", display: "flex", alignItems: "center", gap: "8px" }}>
                      <FaFire style={{ color: "#ef4444" }} /> Most Watched Movies (Last 30 Days)
                    </h3>
                    {mostWatched.length === 0 ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                        {mostWatched.map((movie, index) => (
                          <div key={movie._id} style={{ display: "flex", alignItems: "center", gap: "16px", padding: "12px", background: theme.bgInput, borderRadius: "12px" }}>
                            <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: index === 0 ? "#eab308" : index === 1 ? "#9ca3af" : index === 2 ? "#b45309" : theme.border, color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: "14px", flexShrink: 0 }}>
                              {index + 1}
                            </div>
                            <img src={movie.image} alt={movie.title} onError={e => { e.target.src = "https://placehold.co/40x56/1a1a2e/ffffff?text=M"; }} style={{ width: "40px", height: "56px", objectFit: "cover", borderRadius: "8px", flexShrink: 0 }} />
                            <div style={{ flex: 1 }}>
                              <p style={{ color: theme.textMain, fontWeight: 700, fontSize: "15px", margin: "0 0 4px" }}>{movie.title}</p>
                              <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                                ...
                                <span style={{ color: "#facc15", fontSize: "12px", fontWeight: 700 }}>⭐ {movie.rating}</span>
                                {movie.isPremium && <span style={{ background: "#eab30822", color: "#eab308", fontSize: "10px", padding: "2px 6px", borderRadius: "999px", fontWeight: 700 }}>💎</span>}
                              </div>
                            </div>
                            <div style={{ textAlign: "right", flexShrink: 0 }}>
                              <p style={{ color: "#ef4444", fontWeight: 900, fontSize: "20px", margin: "0 0 2px" }}>{movie.watchCount}</p>
                            ...
                            <div style={{ width: "80px", flexShrink: 0 }}>
                              <div style={{ background: theme.border, borderRadius: "999px", height: "6px", overflow: "hidden" }}>
                                <div style={{ background: "#ef4444", borderRadius: "999px", height: "100%", width: `${Math.min((movie.watchCount / (mostWatched[0]?.watchCount || 1)) * 100, 100)}%`, transition: "width 0.5s" }} />
                              </div>
                            </div>
                          </div>
                        ))}
                  ...
                  <div style={{ background: theme.bgCard, border: "1px solid " + theme.border, borderRadius: "16px", padding: "24px" }}>
                    ...
                    {(() => {
                      ...
                      return sorted.map(([genre, count]) => (
                        <div key={genre} style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                          <span style={{ color: theme.textMain, fontWeight: 600, fontSize: "13px", width: "80px", flexShrink: 0 }}>{genre}</span>
                          <div style={{ flex: 1, background: theme.bgInput, borderRadius: "999px", height: "8px", overflow: "hidden" }}>
                            <div style={{ background: "#dc2626", borderRadius: "999px", height: "100%", width: `${(count / max) * 100}%`, transition: "width 0.5s" }} />
                          </div>
                          <span style={{ color: theme.textSub, fontSize: "13px", fontWeight: 700, width: "24px", textAlign: "right", flexShrink: 0 }}>{count}</span>
                        </div>
                      ));
                    })()}
                  </div>
